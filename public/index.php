...
//debuguear(PropiedadController::class); -> muestra la ubicacion y nombre del archivo

//cuando visite la url /admin, va a ir al controlador PropiedadController y ejecutará el método index
